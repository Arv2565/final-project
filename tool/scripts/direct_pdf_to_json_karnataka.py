"""
Direct PDF to JSON converter for Karnataka Acts using Gemini API.
...
# Configuration
KARNATAKA_ACTS_DIR = Path("/Users/pranav/Documents/Projects/final-project/data/karnataka_acts")
OUTPUT_JSON_PATH = Path("/Users/pranav/Documents/Projects/final-project/data/knowledge_base/karnataka_acts.json")
ERROR_LOG_PATH = Path("/Users/pranav/Documents/Projects/final-project/data/knowledge_base/karnataka_processing_errors.log")
SUMMARY_REPORT_PATH = Path("/Users/pranav/Documents/Projects/final-project/data/knowledge_base/karnataka_processing_summary.txt")
MAX_PAGES_IGNORE = 50
...
def process_pdf_with_gemini(text_content: str, images: List[str], pdf_filename: str) -> Optional[Dict]:
    ...
    try:
        ...
        if text_content:
            # Text-based PDF
            prompt = f"""You are analyzing a Karnataka legal act document: {pdf_filename}
...
Return ONLY valid JSON, no markdown, no explanations."""
            ...
            prompt = f"""You are analyzing a scanned image of a Karnataka legal act: {pdf_filename}
...
def process_all_pdfs(limit: Optional[int] = None, dry_run: bool = False, skip_existing: bool = True):
    """
    Process all PDFs in the karnataka_acts directory.
    ...
    """
    logger.info(f"Starting PDF processing from {KARNATAKA_ACTS_DIR}")
    ...
    # Get all PDFs
    pdf_files = sorted(KARNATAKA_ACTS_DIR.glob("*.pdf"))
    ...
    summary_lines = [
        ...
        f"Input directory: {KARNATAKA_ACTS_DIR}",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert Karnataka Acts PDFs to JSON format")
