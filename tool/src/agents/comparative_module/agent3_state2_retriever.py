...
class Agent3State2Retriever:
    def __init__(self) -> None:
        self.llm = None

    @observe(name="ComparativeModule_Agent3_StateTwoRetriever", as_type="agent")
    def invoke(self, query: str, state_name: str, source_context: str = "", callbacks: List[Any] = []) -> ComparativeStateFindingsOutput:
        try:
            ...
            return self.llm.invoke(
                [
                    {"role": "system", "content": prompts.COMPARATIVE_AGENT3_SYSTEM_PROMPT},
